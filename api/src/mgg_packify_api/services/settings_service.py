...
class SettingsManager:
    ...
    def save_all(self, qa: ServerConfig, prod: ServerConfig, last_used: dict) -> None:
        """
        Guarda toda la configuración de una vez (conveniencia para PUT /settings).

        Args:
            qa: ServerConfig para el ambiente QA.
            prod: ServerConfig para el ambiente PROD.
            last_used: Dict con los últimos valores usados.
        """
        self.save(qa, "QA")
        self.save(prod, "PROD")
        self.save_last_used(last_used)
...
def _merge_with_defaults(loaded: dict) -> dict:
    ...
    # last_used — solo los campos que existen en v3
